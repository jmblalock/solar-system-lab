...
Complete this [activity about the Array method `.sort()`](https://git.generalassemb.ly/sf-sei-3/sort-activity) which is very powerful and can be used to sort arrays in a number of ways.  
